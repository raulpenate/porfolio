---
name: add-portfolio
description: Add a new portfolio entry (education, experience, projects, articles, certifications, awards, or profile fields) from user-provided text, dates, and images. Use when the user runs /add-portfolio or asks to add a new job, school, project, article, cert, or award.
...
6. Insert the entry (newest-first for experience, education, awards, articles; keep related grouping for projects).
